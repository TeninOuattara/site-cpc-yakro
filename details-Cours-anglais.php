...
<head>
    ...
    <title>Centre Polytechnique du Centre Yamoussoukro |apropos</title>
    ...
    <style>
        body {
            padding-top: 0; /* Ajustez en fonction de la hauteur de votre navbar */
        }
        .carousel-item {
            height: 500px; /* Ajustez la hauteur de votre slider */
        }
        .carousel-item img {
            height: 100%;
            object-fit: cover;
...
<body>
    ...
    <!-- <div class="slider-area">
        <div class="page-title">
            <div class="single-slider slider-height slider-height-breadcrumb d-flex align-items-center mt-140 px-90 0" style="background-image: url(img/slider/b1.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider-content slider-content-breadcrumb text-center">
                                <h1 class="white-color f-700">CAFOPLA</h1>
                                <nav class="text-center" aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item"><a href="#">Cabinet D’Assistance
                                             </a></li>
                                        <li class="breadcrumb-item active" aria-current="page">de Formation et de Placement</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
    ...
    <!-- slider-end -->
    <div class=" mt-140 px-90 0 course-details-area gray-bg  pt-100">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="single-course-details-area mb-30">
                        <div class="course-details-thumb">
                            <img src="img/courses/anglais.jpg" alt="">
                        </div>
                        <div class="single-course-details white-bg">
                            <div class="course-details-title mb-20">
                                <h1>How To Improve Your Design (UX/UI, Mobile Apps, UI Design) With Bootstrap Grid System</h1>
                            </div>
    ...
    <div class=" w-75 rounded-5 container align-items-center bg-info ">
        <h1 class="mt-5 mb-4 text-center">Incrivez vous !</h1>
        <form class="  ">
        ...
        <div class="text-center"><button type="submit" class="btn btn-primary">S'inscrire</button></div>  <br>
        </form>
      </div>
    <!-- partenaires -->
...
<ul class="nav justify-content-center border-bottom pb-3 mb-3">
  ...
  <li class="nav-item"><a href="formation superieur.php" class="nav-link px-2 text-body-secondary">CPC Superieur</a></li>
  <li class="nav-item"><a href="formation secondaire.php" class="nav-link px-2 text-body-secondary">CPC Secondaire</a></li>
  <li class="nav-item"><a href="cafopla.php" class="nav-link px-2 text-body-secondary">CAFOPLA</a></li>
  <li class="nav-item"><a href="cours en ligne.php" class="nav-link px-2 text-body-secondary">Cours en ligne</a></li>
</ul>
<a href=""> 
  <p class="text-center text-body-secondary">&copy; 2024 Centre Polytechnique du Centre</p>
</a>
</footer>
</div>
<!-- footer end -->
